													...
													<div
														...
														<div class="p-2">
															<div class="row align-items-center">
																...
																<div class="col pl-0">
																<img alt="${ProductIMGVO.imgName}" src="/displayFile?fileName=${ProductIMGVO.fileLocation}">
																</div>
																<div class="col pl-0">
																	<a href="/displayFile?fileName=${ProductIMGVO.fileLocation}" text-muted font-weight-bold data-dz-name="">
