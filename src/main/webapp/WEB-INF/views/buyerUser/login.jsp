              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your Buyer ID & password to login</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="post" action="/buyerUser/loginPost">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="bPw" class="form-control" id="yourPassword" required>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="/buyerUser/memberRegister">Create an account</a></p>
                    </div>
                  </form>
