...
<head>
  ...
  <title>Dashboard - Startup-Buyer AI B2B Matching Platform</title>
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">${login.sName}</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/startupUser/readPage">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="startup/home">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>바이어 매칭</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/startup/matchingList">
              <i class="bi bi-arrow-repeat"></i><span>바이어 매칭</span>
            </a>
          </li>        
          <li>
            <a href="icons-bootstrap.html">
              <i class="bi bi-card-list"></i><span>매칭 이력</span>
            </a>
          </li>
          <li>
            <a href="icons-remix.html">
              <i class="bi bi-box-arrow-in-right"></i><span>받은 매칭 요청</span>
            </a>
          </li>
          <li>
            <a href="icons-boxicons.html">
              <i class="bi bi-box-arrow-in-left"></i><span>보낸 매칭 요청</span>
            </a>
          </li>
        </ul>
      </li><!-- End Icons Nav -->      
