          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">기업명</label>
                  <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">대표명</label>
                  <div class="col-sm-10">
                    <input type="text" name='names' class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label fw-bold">기업 이메일</label>
                  <div class="col-sm-10">
                 ...
                 <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label fw-bold">설립일</label>
                  <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label fw-bold">규모</label>
                  <div class="col-sm-10">
           ...
           <!--      <div class="row mb-3">
               ...
               <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold" >업종</label>
                  <div class="col-sm-10">
                     <input type="text" name='categorys' class="form-control">
                  </div>
                </div>
                    <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">업태</label>
                  <div class="col-sm-10">
                   <input type="text" name='business' class="form-control">
                  </div>
                </div>
                    <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">직원수</label>
                  <div class="col-sm-10">
                    <input type="text" name='noOfEmployees' class="form-control">
                  </div>
                </div>
                    <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">주소</label>
                  <div class="col-sm-10">
                     <input type="text" name='city' class="form-control">
                  </div>
                </div>
                   <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label fw-bold">주력상품</label>
                  <div class="col-sm-10">
              ...
              <!--    <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="formFile">
                        ...
                        <label for="inputText" class="col-sm-2 col-form-label fw-bold">사업자 등록증 </label>
