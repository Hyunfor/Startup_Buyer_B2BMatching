          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name='startup_id' class="form-control">
                  </div>
                </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     <input type="date" name='established_Year' class="form-control">
                  </div>
                </div>
           ...
           <!--      <div class="row mb-3">
               ...
               <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name='no_Of_Employees' class="form-control">
                  </div>
                </div>
                    <div class="row mb-3">
