						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingOne">
								<button class="accordion-button" type="button"
									...
									<i class="bi bi-box-arrow-in-right"></i>&nbsp;&nbsp;바이어 1
								</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingTwo">
								<button class="accordion-button collapsed" type="button"
									...
									<i class="bi bi-box-arrow-in-right"></i>&nbsp;&nbsp;바이어 2
								</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="headingThree">
								<button class="accordion-button collapsed" type="button"
									...
									<i class="bi bi-box-arrow-in-right"></i>&nbsp;&nbsp;바이어 3
								</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingOne">
								<button class="accordion-button collapsed" type="button"
									...
									<i class="bi bi-box-arrow-in-left"></i>&nbsp;&nbsp;바이어 1
								</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingTwo">
								<button class="accordion-button collapsed" type="button"
									...
									<i class="bi bi-box-arrow-in-left"></i>&nbsp;&nbsp;바이어 2
								</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-headingThree">
								<button class="accordion-button collapsed" type="button"
									...
									<i class="bi bi-box-arrow-in-left"></i>&nbsp;&nbsp;바이어 3
								</button>
							</h2>
