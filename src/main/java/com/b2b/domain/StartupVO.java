...
public class StartupVO {
	...
	private String no_Of_Employess;
	private String city;
	...
	public String getNo_Of_Employess() {
		return no_Of_Employess;
	}
	public void setNo_Of_Employess(String no_Of_Employess) {
	...
	public String toString() {
		return "StartupVO [startup_id=" + startup_id + ", startupName=" + startupName + ", established_Year="
				...
				+ ", no_Of_Employess=" + no_Of_Employess + ", city=" + city + ", items=" + items + ", email=" + email
